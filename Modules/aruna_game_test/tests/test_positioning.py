...
class TestPositioning(TransactionCase):
    ...
    def test_1_placing_object(self):
        ...
        # be discarded, in other word while not is_placed, any movement command
        # will be ignored.
        ...
        self.base_game.with_context(
            turn_direction=eObjectTurnDirection.right.value).turn_robot()
    ...
    def test_3_placing_out_of_bound_area(self):
        ...
        self.assertEqual(
            self.base_game.report,
            '(Robot Position is Outside the Table, Report Ignored)')
